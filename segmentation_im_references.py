...
[F1_planmed, F1_planmed_mask, mesures]=pipeline_segm_fibre(imref_planmed, mask_planmed)
...
[F1_ge, F1_ge_mask]=pipeline_segm_fibre(imref_ge, mask_ge, zone_fibre_n=[0.10,0.21], zone_fibre_p=[0.66,0.83])
